...
> **Provenance:** Ported verbatim from [garrytan/gbrain](https://github.com/garrytan/gbrain) v0.32.3.0 (MIT). Path references like `evals/functional-area-resolver/` point to the upstream gbrain repo, not anywhere in hermes-agent.
