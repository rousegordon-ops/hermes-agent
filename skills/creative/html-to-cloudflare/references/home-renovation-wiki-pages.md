...
3. Create or patch hand-written HTML directly under `/opt/data/hermes-pages/wiki/...`.
   ...
   - **Terse edit rule:** when Gordon flags a passage as redundant, unnecessary, or “AI slop,” delete the redundant bullets/section outright unless he explicitly asks for a rewrite. Do not keep the same checklist content under softer wording. If one useful sentence remains, move it into the nearest existing section and remove the extra heading/list.
